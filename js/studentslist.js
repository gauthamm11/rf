            ...
            <a data-bs-toggle="collapse" href="#${studentID}">
              <div class="card-header">
                <div class="d-flex justify-content-between">
                  <div class="px-1"><strong style="color:#1D3557;">${student.name}</strong></div>
                  ${Object.entries(student.grades)
                    .map(([subject, grade]) => `<div class="px-1"><i class="px-2">${subject}</i> <strong style="color:#1D3557;">${grade}</strong></div>`)
                    .join("")}
                  <div class="px-1"><strong style="color:#E63946;">Total ${student.total}</strong></div>
                </div>
              </div>
            </a>
          `;
